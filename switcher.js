...
(function() {
  window.ViewSwitcher = function(options) {
    var attrIdentifier, container, defaultTransitions, enter, exit, finishRender, hub, initialView, onFinish, prepare, rawViews, state, switchView, timedOffsets, useHistory, views, _off, _on, _trigger;
    defaultTransitions = {
    ...
    finishRender = function(incomingView) {
      state.pastViews.push(state.activeView);
      state.activeView = incomingView;
      return _trigger("renderComplete", state.activeView);
    };
